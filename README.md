...
Livenza Life operations workspace presented through the Tesla OS 27 warm-neutral macOS-inspired interface.
...
## Interface
- One active warm-neutral Liquid Glass theme with no decorative blue/cyan chrome.
- Persistent macOS-style bottom Dock that remains visible while pages scroll.
- Exactly one Dock launcher: **Suites**.
- Clean Home workspace with the animated Livenza AI identity rather than dashboard clutter.
- Unified **System Settings** for account, appearance, widgets, integrations, users, security, automations, organisation controls and About information.
- Central Livenza symbol system, responsive layout support and reduced-motion behavior.
- Tesla OS identity in System Settings → About: **Tesla OS 27 / Version 27.0.1 / Build 27A101**.
...
2. Confirm the Home workspace shows the animated Livenza AI identity with the persistent Suites Dock.
